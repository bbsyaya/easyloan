package com.vinnypay.easyloan.constants;
...
public class RegexRule {
    ...
    /** 身份证号（15位或18位） */
    public static final String ID_CARD                   = "^[0-9|X]{15}|[0-9|X|x]{18}$";
    ...
    /** 银行卡号 */
    public static final String BANKCARD_NO_2               = "^\\d{6,25}$";

    /** 银行开户名 */
    public static final String ACCOUNT_NAME              = "^.{1,20}$";
    
    public static final String CVV2_NUM               = "^\\d{3}$";
